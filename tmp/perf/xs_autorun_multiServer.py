...
perf_base_path = ""
gcc12Enable = True
emuArgR = "/nfs-nvme/home/share/zyy/shared_payloads/gcb-restorer.bin"
...
def xs_run(server_list, workloads, xs_path, warmup, max_instr, threads, version=2006, dry_run=False, verbose=True):
  ...
  if gcc12Enable:
    base_arguments = [emu_path, '--dramsim3-ini', '/nfs/home/zhangyuxin/spec_test/0218_spec_test/DRAMsim3/configs/xiangshan_DDR4_8Gb_x8_3200_1ch_xmp.ini' , '--diff', nemu_so_path, '--enable-fork', '-W', str(warmup), '-I', str(max_instr), '-i']
